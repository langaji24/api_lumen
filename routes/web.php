...
// router inboundStuff
$router->group(['prefix' => 'inbound-stuff/', 'middleware' => 'cors'], function() use ($router) {
    // static routes
...
// router stuffStock
$router->group(['prefix' => 'stuff-Stock', 'middleware' => 'cors'], function () use ($router) {
    // static routes
...
// router lending
$router->group(['prefix' => 'lending', 'middleware' => 'cors'], function () use ($router) {
    // static routes
...
// router restoration
$router->group(['prefix' => 'restoration', 'middleware' => 'cors'], function() use($router){
    // static routes
