...
class StuffController extends Controller
{
    ...
    public function index()
    {
        try{
            ...
            return ApiFormatter::sendResponse(200,'Lihat semua barang', $stuff);
    ...
    {
        try {
            $data = Stuff::where('id', $id)->with('stuffStock', 'inboundStuffs', 'lending')->first();
    ...
    public function destroy($id)
    {
        try {
            ...
            if ($stuff->inboundStuffs()->exists() || $stuff->stuffStock()->exists() || $stuff->lending()->exists()) {
